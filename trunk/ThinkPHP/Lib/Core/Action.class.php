...
abstract class Action {
   ...
   /**
    ...
    protected function error($message,$jumpUrl='',$ajax=false) {
        $this->dispatchJump($message,"300",$jumpUrl,$ajax);
		exit();
    }
    ...
    protected function success($message,$jumpUrl='',$ajax=false) {
        $this->dispatchJump($message,"200",$jumpUrl,$ajax);
    }
     ...
     * @return void
     */
    protected function successNoClose($message,$jumpUrl='',$ajax=false) {
        $this->dispatchJump($message,"200",$jumpUrl,$ajax, '');
    }
    ...
    protected function ajaxReturn($data,$type='') {
		...
		{
			$data['navTabId']  =  $_REQUEST['navTabId'];	/* 修改2012.12.2 ysg */	
		}
     ...
     * @return void
     */
    private function dispatchJump($message,$status=1,$jumpUrl='',$ajax=false, $callbackType = "closeCurrent") {
